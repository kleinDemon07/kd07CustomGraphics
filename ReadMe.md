# Flipper Zero FW [KLEINDEMON]
This firmware is a fork of [ROGUEMASTER](https://github.com/RogueMaster/flipperzero-firmware-wPlugins) made to personalize my own flipper. I will be attempting to keep this fairly updated with RogueMaster's dev releases. The difference will be the graphics!
So after the description, this ReadMe is going to simply be a copy/paste of the RogueMaster ReadMe.

## Concept
The Klein Demon is a being that can be called forth using a Klein Bottle. Utilizing the Flipper Zero, you can capture and nurture one of these creatures!
